...
import fr.mathdu07.visualshop.player.ability.CreateAdminBuyShopAbility;
import fr.mathdu07.visualshop.util.VsItemStack;

public class VsAdminBuyCommand extends VsSubCommand {
	...
	public void performCommand(CommandSender sender, String[] args) {
		...
		try {
			...
			try {
				p.addAbility(new CreateAdminBuyShopAbility(p, price, is));
	...
	public String getPermission() {
		return VsPermissions.ADMIN_CREATE_BUY;
	}
